<template>
  <div class="shoucang">
    <headnav>
      <div class="wy-header-title" slot="title">收藏</div>
    </headnav>
    ...
    <div class="pro-items">
      <div class="weui-media-box weui-media-box_appmsg">
        ...
        <div class="weui-media-box__bd">
          <h1 class="weui-media-box__desc"><a href="pro_info.html" class="ord-pro-link">由各种物质组成的巨型球状天体，叫做星球。星球有一定的形状，有自己的运行轨道。</a></h1>
